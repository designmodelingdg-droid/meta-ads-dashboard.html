/* Prueba del embudo completo de la guia Revit + ChatGPT.
 *
 ...
 *
 *   node guia-revit-ia/prueba/embudo.js
 */
...
(async()=>{
  ...
  const local = B + href.split('/guia-revit-ia/')[1];
  ...
  console.log('   prompts disponibles   :', await p.locator('.copiar').count());
