<!--
Traido de sergebulaev/linkedin-skills (MIT), sin modificar el contenido.

  MIT License · Copyright (c) 2026 Sergey Bulaev
  https://github.com/sergebulaev/linkedin-skills

Se copia en vez de enlazarse porque el repositorio de la matriz tiene que
poder leerse sin red, y porque un enlace a un repo ajeno puede cambiar debajo.
Si hace falta actualizarlo, se vuelve a copiar y se dice en el commit.

OJO AL LEERLO: esta escrito para PERFILES PERSONALES en ingles y para un
mercado B2B de EE.UU. Lo que aplica y lo que NO a Design Modeling esta en el
SKILL.md de esta carpeta — leelo antes que esto.
-->
