/* Prueba del embudo completo de la pack starter de Dynamo.
 *
 ...
 *
 *   node pack-dynamo/prueba/embudo.js
 */
...
(async()=>{
  ...
  const local = B + href.split('/pack-dynamo/')[1];
  ...
  console.log('   fichas de la guía     :', await p.locator('.sec .n').count(), '(5 scripts + instalación + compatibilidad = 7)');
