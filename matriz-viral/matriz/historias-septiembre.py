  ...
  "dias": [
   ...
   {"dia": "Viernes 25", "titulo": "«Según la norma» no es una cita",
    ...
    "historias": [
     ...
     {"rol": "RECURSO", "texto": "Es uno de los 6 motivos por los que devuelven una memoria. Los 6, con el ejemplo corregido y la plantilla en Word, están en la guía gratis.",
      "sticker": "ENLACE: funnel.dgdesignmodeling.com/acceso-gratis-memoria-calculo-form (texto del sticker: «Guía gratis»). No usar «responde MEMORIA»: la campaña MEMORIA de OpenReply está pausada.",
      "fondo": "REAL · pantalla",
  ...
  "dias": [
   ...
   {"dia": "Martes 29", "titulo": "Sale la guía de memoria de cálculo",
    ...
    "historias": [
     ...
     {"rol": "RECURSO", "texto": "Guía + plantilla en Word + Excel de verificaciones. Gratis.",
      "sticker": "ENLACE: funnel.dgdesignmodeling.com/acceso-gratis-memoria-calculo-form («Guía gratis»). Si ese día la campaña MEMORIA de OpenReply ya está activa y dispara por DM, se puede sumar «o respóndeme MEMORIA».",
      "fondo": "REAL · pantalla",
   ...
   {"dia": "Jueves 1 de octubre", "titulo": "Respuestas + la guía una vez más",
    ...
    "historias": [
     ...
     {"rol": "RECURSO", "texto": "Si todavía no tienes la guía, está aquí.",
      "sticker": "ENLACE: funnel.dgdesignmodeling.com/acceso-gratis-memoria-calculo-form («Guía gratis»).",
      "fondo": "REAL · pantalla",
